...
function processFormFieldsIndividual(req, res) {
    ...
    form.on('end', function () {
        ...
        //write json to Mongo:
        var doc_id = dataapi.insert_doc(app_mongo, jsonObj); //if need to edit number jsonObj.house_number
...
//TODO user and pw for mongo server


//define api functions:
var main_server = {
    spaces: null,
    process_form: processFormFieldsIndividual
};
